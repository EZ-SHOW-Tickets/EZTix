...
<!--
	...
	function CheckMethod(sPaymentMethod){
		if(sPaymentMethod == "CC"){
			document.kspaymentreview.action = "freePaymentAndReceipt.asp";
			//document.kspaymentreview.action = "https://secure.authorize.net/gateway/transact.dll";
			document.kspaymentreview.submit();
		}
		else if(sPaymentMethod == "PP"){
			document.kspaymentreview.action = "NLBWA/ANTicketReceiptMyPay.asp";
			document.kspaymentreview.submit();
		}
		else if(sPaymentMethod == "USA"){
			document.kspaymentreview.action = "USAePay/ANTicketReceiptUSAePay.asp";
			document.kspaymentreview.submit();
		}
		else{
			//document.kspaymentreview.action = "http:/www.ez-show-tickets.com/v4/admin/AccountAdmin.asp";
			document.kspaymentreview.action = "ANTicketReceipt.asp";
			document.kspaymentreview.submit();
		}
	}
...
<form method="post" action="freepaymentandreceipt.asp" name="kspaymentreview">
			...
			<tr>
				<td>
					<p align="left">
        				...
        				</font><font color="#FF0000" face="Verdana"> <i><b> ONLY ONCE</b></i></font><font face="Verdana" size="2">. If there is an error while authorizing the payment information, please click the button to go back and correct the information and then re-submit again.
        				</font>
        		</td>
			</tr>
        	<tr>              
				...
				<a href="setupPayment.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/BackON.gif',1)"><img name="Image1" border="0" src="images/Back.gif" align="middle" WIDTH="103" HEIGHT="32"></a>
