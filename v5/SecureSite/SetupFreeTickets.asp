...
function CheckEMail(){
	if (document.RegisteredEMail.regEmail.value=="")
		...
		{document.location='SetupFreeTickets.asp?TestEmail='+document.RegisteredEMail.regEmail.value;}
...
<body onLoad="MM_preloadImages('images/CancelTicketsON.gif','images/PurchaseSeatsON.gif','images/PressHereON.gif')">
 ...
 <!--             <td width="140" bgcolor="#FFFFFF">&nbsp;</td>              <td width="10" bgcolor="#FFFFFF">&nbsp;</td>-->
			...
			<form method="post" name="fProcessPayment" action="ProcessFreePayment.asp">
            ...
            <tr>
              <td width="140" align="center">
				<!--	<div id="digicertsitesealcode" style="width: 81px; margin: 5px auto 5px 5px;" align="center">
					...
					<div id="digicertsitesealcode" style="width: 81px; margin: 5px auto 5px 5px;" align="center"><script language="javascript" type="text/javascript" src="https://www.digicert.com/custsupport/sealtable.php?order_id=00211258&amp;seal_type=a&amp;seal_size=large&amp;seal_color=blue&amp;new=1"></script><a href="http://www.digicert.com/ssl.htm">SSL Certificates</a><script language="javascript" type="text/javascript">coderz();</script></div>
