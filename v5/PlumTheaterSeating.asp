...
%>
<!--#INCLUDE file="ConstructPlumSeating.asp"-->
...
function SubmitSelection(n){
//alert(n);
if (document.SeatingForm.NumberOfClicks.value==0)
	{alert("Please select your seats!");
	 return;}
else if (document.SeatingForm.NumberOfClicks.value!=n)
   {alert("Please select "+n+" seats");
    return;
   }
else
	//{document.SeatingForm.action='verifySeats.asp';
	{document.SeatingForm.action='selectPlumseattype.asp';
...
function GoBack(){
document.location='SelectPlumPerformance.asp';
}
								...
								<td width="100%" height="33" align="center" bgcolor="#FFFFCC">
									<p align="center">
									    <!--<input type="button" value="PLEASE SELECT SEATS ABOVE AND PRESS HERE" onclick="javascript:SubmitSelection();">-->
       			        				<a href="javascript:SubmitSelection(<%=numTix%>);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','images/SelectSeatsAboveON.gif',1)"><img name="Image2" border="0" src="images/SelectSeatsAbove.gif" WIDTH="350" HEIGHT="32"></a>
