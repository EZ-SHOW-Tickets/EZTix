...
'Get all ticket types for this performance
	...
	strLegend="<table><tr><td bgcolor='#C0C0C0'><font face='Arial' size='2'>Sold</font></td>"    '<td bgcolor='#00CC99'><font face='Arial' size='2'>General Admission</font></td><td  bgcolor='#C0C0C0'><font face='Arial' size='2'>Taken</font></td><td  bgcolor='#0066CC'><font face='Arial' size='2' color='white'>Season Tickets</font></td></tr></table>"
	'do until rsSeatingTypes.eof
	'	if rsSeatingTypes("SeatingCategoryID")=1 or rsSeatingTypes("SeatingCategoryID")=2 then
			strLegend=strLegend & "<td bgcolor='" & Green & "'><font face='Arial' size='2' color='#FFFFFF'><input type='radio' name='SeatType' value='100'>Available</font></td>"
	'	elseif rsSeatingTypes("SeatingCategoryID")=110 then
			strLegend=strLegend & "<td bgcolor='" & Red & "'><font face='Arial' size='2' color='#FFFFFF'><input type='radio' name='SeatType' value='110'>Block</font></td>"
	'	elseif rsSeatingTypes("SeatingCategoryID")=120 then
			strLegend=strLegend & "<td bgcolor='" & Blue & "'><font face='Arial' size='2' color='#FFFFFF'><input type='radio' name='SeatType' value='120'>Season Tickets</font></td>"
	'	elseif rsSeatingTypes("SeatingCategoryID")=130 then
			strLegend=strLegend & "<td bgcolor='" & Orange & "'><font face='Arial' size='2' color='#FFFFFF'><input type='radio' name='SeatType' value='130'>HC</font></td>"
	'	end if
