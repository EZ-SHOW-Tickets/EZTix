...
dim strCost
dim numTEA
session("AccountID")=64
session("ShowID")=973
''session("PerformanceID")=4863
'dim totalSeats
'INITIALIZE
strShowName=""
strShowNote=""
	...
	if Request.QueryString.Count > 0 then
		...
		for i=1 to ubound(Seats,2)
			...
			do until rsPrices.eof
				...
				j=j+1
				strCost= strCost & "<tr>"
				if session("AccountID")="3" and numTEA > 190 and rsPrices("PriceCategoryID")=6 and session("Admin")="0" then
                      					...
                      					<!--				<td width="120" height="1" valign="top" align="left" colspan="1">                      										<font face="Verdana" size="2"><b>Performance:</b></font>                      									</td>-->
                    								...
                    								<tr>
                      								<td width="420" height="6" colspan="2">
                      									...
                      									<!--<input type="button" value="Press HERE to select SEATS for ANOTHER SHOW" onclick="javascript:PurchaseTickets(<=j>,<=totalSeats>,1);" id=button2 name=button2>-->
                                            		</td>
                    								</tr>
                    								<tr>
