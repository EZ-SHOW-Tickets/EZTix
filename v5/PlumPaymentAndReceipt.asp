...
<%
		...
		ReceiptID=insertrecord("Insert Into PAYMENT_RECEIPTS (AmountPaid,AmountDue,PaymentBy,ReservedForFN,ReservedForLN,TransactionID,PurchaseReference) values(0.00 ,0.00," & PersonID & ",'" & ReserveForFName & "','" & ReserveForLName & "'," & Transaction_ID & ",'" & strReference & "')","PAYMENT_RECEIPTS","PaymentReceiptID")
    ...
    <tr>
      <td width="100%" height="1">
			<table border="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="650" id="AutoNumber1" cellpadding="0">
				...
				<tr>
					<td width="650"><font face="Arial" size="2">Certificate(s): <%=strReference%>&nbsp;Please bring to theater </font>
					</td>
				</tr>
				<tr>
					<td width="650">
