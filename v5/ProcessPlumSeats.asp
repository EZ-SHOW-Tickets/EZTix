...
<% 
	...
	if Request.Form("MoreTicks")="0" then
		...
		Response.Redirect "SetupPlumPayment.asp?PerfomanceID=" & PerformanceID & "&AccountID=" & session("AccountID") & "&Admin=" & session("Admin") & "&lSessionID=" & session("lSessionID")	
		''''''''TEST MODE
		...
		Response.Redirect "PlumOrder.asp"		
	end if
%>
<html>
