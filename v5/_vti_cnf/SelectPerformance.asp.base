...
function SelectPerformanceNew(n)
{
	...
	{document.location="ProcessPerformance.asp?PerformanceID="+document.fSelectPerformance.sPerformance.value;}
	else
	{document.location="ProcessPerformance.asp?PerformanceID="+document.fSelectPerformance.sPerformance[n].value;}
}
...
if (show==0) {alert("Please select a performance date");}
	else{document.location="ProcessPerformance.asp?PerformanceID="+show;}				 
}
        					...
        					<tr>
                                ...
                                <br><font face="Arial" size="1"><%=strShowSummary%></font></p></td>
          						<td width="60%" valign="top" align="left" height="115">
                					...
                					<br><font face="verdana,arial,helvetica,sans-serif" size="1" color="#000080"><b>On-Line Sales close <%=ShowHoldHours%> hours before performance<br>Tickets are available at the theater on day of show</b></font>
                  					<!--<p></p>-->
                  				</td>
