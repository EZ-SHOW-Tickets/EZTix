<% 
	...
	strPurchase=strPurchase &  "<td width='203' align='center' ><b><font face='Arial' >Show</font></b></td>"
	...
	do until rsPerformances.eof
		...
		if seats(1,i)=2 then 'Unreserved
			strPurchase=strPurchase & "<tr><td width='115'><font face='Arial' size='1'>" & strShowName & "</td><td width='141'><font face='Arial' size='2'>" & formatdatetime(strPerformanceDate,vbshortdate) & " " & strPerformanceTime & "</td><td width='110'><font face='Arial' size='2'>" & totalTickets & "(" & strNumberEach & ")</td><td width='191'><font face='Arial' size='2'></td><td width='71'><font face='Arial' size='2'>" & formatcurrency(totalTicketCost,2) & "</td></tr>"
		else
			strPurchase=strPurchase & "<tr><td width='115'><font face='Arial' size='1'>" & strShowName & "</td><td width='141'><font face='Arial' size='2'>" & formatdatetime(strPerformanceDate,vbshortdate) & " " & strPerformanceTime & "</td><td width='110'><font face='Arial' size='2'>" & totalTickets & "(" & strNumberEach & ")</td><td width='191'><font face='Arial' size='2'>" & Seats(4,i) & "</td><td width='71'><font face='Arial' size='2'>" & formatcurrency(totalTicketCost,2) & "</td></tr>"
		end if		
		...
		actualTicketCost=actualTicketCost+totalTicketCost + totServiceCharge
	...
	loop
	 ...
	 strPurchase=strPurchase &  "<td width='71' align='center' ><b><font face='Arial' ><input name='tTicketCost' value='" & formatcurrency(actualTicketCost,2) & "' size='5' readonly></font></b></td>"
	 strPurchase=strPurchase &  "</tr>"
%>