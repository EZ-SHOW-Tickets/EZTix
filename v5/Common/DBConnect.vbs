...
'm_oConnection.ConnectionString = "DRIVER={SQL Server};SERVER=209.204.62.15;DATABASE=OCHSA;UID=sa;PWD=cgcuser"
m_oConnection.ConnectionString = "DRIVER={SQL Server};SERVER=129.47.1.163;DATABASE=OCHSA;UID=sa;PWD=cgcuser"
m_oConnection.Open
